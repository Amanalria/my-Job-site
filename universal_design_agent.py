...
<td colspan="2" style="padding: 10px 12px; border: 1px solid #ddd; background-color: {'#ffffff' if idx % 2 == 1 else '#f9f9f9'};">
  <strong style="color: #000080; font-size: 15.5px; font-family: 'Times New Roman', Times, serif, Hind, sans-serif;">Q{idx}. {f.get('q', '')}</strong><br/>
  <span style="color: #222222; font-size: 14.5px; line-height: 1.5; font-family: 'Times New Roman', Times, serif, Hind, sans-serif;">Ans: {f.get('a', '')}</span>
</td>
</tr>"""
...
<tbody>
<tr>
<td colspan="2" style="background-color: #000080; color: #ffffff; font-size: 16px; font-weight: 700; text-align: center; padding: 10px; font-family: 'Times New Roman', Times, serif, Hind, sans-serif;">
...
<div class="st-app-download-box gb-container gb-container-ce6e23c9" style="margin: 20px 0; text-align: center; background: #fdfaf2; border: 1px solid #e2d7be; border-radius: 6px; padding: 16px;">
  <p class="gb-headline" style="margin: 0 0 6px 0;"><span style="font-size: 20px; font-weight: 800; color: #5b032f; font-family: 'Times New Roman', Times, serif, Hind, sans-serif;">StudyTopper.in</span></p>
  <p style="margin: 6px 0 14px 0; font-size: 14.5px; color: #444444; font-family: 'Times New Roman', Times, serif, Hind, sans-serif;">Fastest Government Job Updates, Results, Admit Cards & Exam Syllabus Portal</p>
  <p style="margin: 0;">
...
<tr>
  <td style="width: 50%; padding: 14px; vertical-align: top; border-right: 1px solid #ddd; background: #ffffff;">
    <h3 style="margin: 0 0 10px 0; color: #ef0303; font-size: 17px; font-weight: 700; border-bottom: 2px solid #ef0303; padding-bottom: 4px; font-family: 'Times New Roman', Times, serif, Hind, sans-serif;">Latest Posts</h3>
    {latest_html}
  </td>
  <td style="width: 50%; padding: 14px; vertical-align: top; background: #ffffff;">
    <h3 style="margin: 0 0 10px 0; color: #000080; font-size: 17px; font-weight: 700; border-bottom: 2px solid #000080; padding-bottom: 4px; font-family: 'Times New Roman', Times, serif, Hind, sans-serif;">Related Posts</h3>
    {related_html}
  </td>
</tr>
</tbody>
...
<p style="text-align: center; font-size: 13.5px; line-height: 1.5; color: #333333; margin: 15px 0 8px 0; font-family: 'Times New Roman', Times, serif, Hind, sans-serif;">
...
<p style="font-size: 12px; line-height: 1.5; color: #666666; text-align: justify; margin: 0 0 25px 0; font-family: 'Times New Roman', Times, serif, Hind, sans-serif;">
...
<span style="font-size: 19px; font-weight: 800; color: #000000; font-family: 'Times New Roman', Times, serif, Hind, sans-serif;">{t}</span>
</td>
<td style="width: 50%; padding: 14px 16px; text-align: center;">
<span style="font-size: 20px; font-weight: 800; font-family: 'Times New Roman', Times, serif, Hind, sans-serif;"><a href="{u}" aria-label="{aria}" rel="noopener noreferrer" style="color: #0000ef; font-weight: 800; text-decoration: none;" {target}>Click Here</a></span>
</td>
</tr>"""
...
<h1 class="gb-headline gb-headline-e52a0102 gb-headline-text" style="font-size: 22px; font-weight: 700; color: #0000cd; text-align: left; margin: 8px 0 4px 0; line-height: 1.3; width: 100%; font-family: 'Times New Roman', Times, serif, Hind, sans-serif;">{title}</h1>
<div class="gb-container gb-container-659bd175"><p style="color: #cd0808; font-weight: 700; font-size: 15px; margin: 2px 0 7px 0; text-align: left; font-family: 'Times New Roman', Times, serif, Hind, sans-serif;">Post Date: {post_date}</p></div>
<p class="gb-headline gb-headline-550ae316 short_Details gb-headline-text" style="width: 100%; max-width: 100%; font-size: 16.8px; line-height: 1.55; color: #000000; text-align: justify; text-justify: inter-word; margin: 8px 0 14px 0; display: block; font-family: 'Times New Roman', Times, serif, Hind, sans-serif;">{overview_html}</p>
...
<h2 class="gb-headline gb-headline-2ca5a791 gb-headline-text" style="font-size: 16px; font-weight: 700; text-align: center; color: #ef0303; line-height: 1.3; padding: 6px 4px; margin: 0; background: #ffffff; font-family: 'Times New Roman', Times, serif, Hind, sans-serif;">{title} &ndash; Latest Details &amp; Updates</h2>
<h3 class="gb-headline gb-headline-7d5f86e8 gb-headline-text" style="font-size: 16px; font-weight: 600; text-align: center; color: #009703; line-height: 1.25; margin: 0; padding: 2px 4px 6px 4px; background: #ffffff; font-family: 'Times New Roman', Times, serif, Hind, sans-serif;">{org} : Details &amp; Summary</h3>
<p class="gb-headline gb-headline-79adf169 gb-headline-text" style="margin: 0 0 6px 0; font-family: 'Times New Roman', Times, serif, Hind, sans-serif; text-align: center; font-size: 18px; font-weight: 700;"><a href="/" style="color: #0000ff; text-decoration: underline;">StudyTopper.in</a></p>
...
<div class="st-grid-row" style="display: flex; flex-wrap: wrap; width: 100%; border-top: 2px solid #5b032f; margin: 0; padding: 0; box-sizing: border-box;">
  ...
  <div class="st-col-half st-col-border-right" style="box-sizing: border-box; vertical-align: top;">
    <div style="background-color: #5b032f; color: #ffffff; padding: 8px 10px; font-size: 20px; font-weight: 700; text-align: center; font-family: 'Times New Roman', Times, serif, Hind, sans-serif;">{box1_left_title}</div>
    <div style="padding: 12px 14px; background-color: #ffffff;">
      <ul style="padding-left: 20px; margin: 0; list-style-type: disc; text-align: left; font-size: 14pt; line-height: 1.6; font-family: 'Times New Roman', Times, serif, Hind, sans-serif;">
        {dates_li}
      </ul>
    </div>
  </div>
  ...
  <div class="st-col-half" style="box-sizing: border-box; vertical-align: top;">
    <div style="background-color: #5b032f; color: #ffffff; padding: 8px 10px; font-size: 20px; font-weight: 700; text-align: center; font-family: 'Times New Roman', Times, serif, Hind, sans-serif;">{box1_right_title}</div>
    <div style="padding: 12px 14px; background-color: #ffffff;">
      <ul style="padding-left: 20px; margin: 0; list-style-type: disc; text-align: left; font-size: 14pt; line-height: 1.6; font-family: 'Times New Roman', Times, serif, Hind, sans-serif;">
        {fee_li}
      </ul>
      <div style="margin-top: 10px; font-size: 14pt; line-height: 1.5; color: #000000; border-top: 1px dashed #ccc; padding-top: 8px; font-family: 'Times New Roman', Times, serif, Hind, sans-serif;">
...
<div class="st-grid-row" style="display: flex; flex-wrap: wrap; width: 100%; border-top: 2px solid #5b032f; margin: 0; padding: 0; box-sizing: border-box;">
  <!-- Left Col: Age Limits -->
  <div class="st-col-half st-col-border-right" style="box-sizing: border-box; vertical-align: top;">
    <div style="background-color: #046132; color: #ffffff; padding: 8px 10px; font-size: 17px; font-weight: 700; text-align: center; font-family: 'Times New Roman', Times, serif, Hind, sans-serif;">{box2_left_title}</div>
    <div style="padding: 12px 14px; background-color: #ffffff;">
      <ul style="padding-left: 20px; margin: 0; list-style-type: disc; text-align: left; font-size: 14pt; line-height: 1.6; font-family: 'Times New Roman', Times, serif, Hind, sans-serif;">
        {age_li}
      </ul>
  ...
  <div class="st-col-half" style="box-sizing: border-box; vertical-align: top;">
    <div style="background-color: #f53c00; color: #ffffff; padding: 8px 10px; font-size: 20px; font-weight: 700; text-align: center; font-family: 'Times New Roman', Times, serif, Hind, sans-serif;">{box2_right_title}</div>
    <div style="padding: 24px 10px; background-color: #ffffff; text-align: center;">
      <span style="font-size: 28px; font-weight: 800; color: #000000; font-family: 'Times New Roman', Times, serif, Hind, sans-serif;">{total_posts}</span>
    </div>
  </div>
</div>
</div>
...
<h2 class="gb-headline gb-headline-c7683bda gb-headline-text" style="font-size: 24px; font-weight: 800; text-align: center; color: #ef0303; line-height: 1.35; margin: 20px 0 12px 0; padding: 6px 4px; font-family: 'Times New Roman', Times, serif, Hind, sans-serif;">{title} : Key Overview &amp; Matrix</h2>
...
<tbody>
<tr>
<th style="background-color: #f53c00; color: #ffffff; padding: 6px 10px; text-align: center; border: 1px solid #d35400; font-size: 15px; font-weight: 700; font-family: 'Times New Roman', Times, serif, Hind, sans-serif;">{tbl2_th1}</th>
<th style="background-color: #f53c00; color: #ffffff; padding: 6px 10px; text-align: center; border: 1px solid #d35400; font-size: 15px; font-weight: 700; font-family: 'Times New Roman', Times, serif, Hind, sans-serif;">{tbl2_th2}</th>
<th style="background-color: #f53c00; color: #ffffff; padding: 6px 10px; text-align: center; border: 1px solid #d35400; font-size: 15px; font-weight: 700; font-family: 'Times New Roman', Times, serif, Hind, sans-serif;">{tbl2_th3}</th>
</tr>
{post_rows}
</tbody>
</table>
...
<h3 style="margin: 0; color: #ff0000; font-size: 20px; font-weight: 800; text-transform: uppercase; font-family: 'Times New Roman', Times, serif, Hind, sans-serif;">SOME USEFUL IMPORTANT LINKS</h3>
</td>
</tr>
